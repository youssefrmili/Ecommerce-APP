...
curl -o $TARGET_DIR/microservices/ecomm-ui.yml https://raw.githubusercontent.com/youssefrmili/Ecommerce-APP/test/test_manifests/microservices/ecomm-ui.yml
