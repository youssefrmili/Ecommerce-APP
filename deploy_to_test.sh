...
curl -o $TARGET_DIR/microservices/ecomm-user.yml https://raw.githubusercontent.com/youssefrmili/Ecommerce-APP/test/test_manifests/microservices/ecomm-user.yml
